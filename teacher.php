...
extract($_GET);
if(isset($delete_id)){
    mysqli_query($conn,"Delete from teacher where teacher_id=$delete_id");
    $msg['success']="This record has been deleted successfully";
}

if(isset($edit_id) AND $edit_id> 0){
$sql="Select * from teacher where teacher_id='".$edit_id."'";
...
if(isset($_POST['is_submit'])){
    ...
    if(empty($error)){
$duplicatecheckquery="  SELECT * from teacher 
                                WHERE full_name='".$full_name."'
                                AND address='".$address."'
                                AND phone_no='".$phone_no."'";
    if(isset($edit_id)&& $edit_id>0){
            $duplicatecheckquery.= "AND teacher_id != '".$edit_id."'";
    } 
        ...
        if(mysqli_num_rows($result)==0){
            if(isset($edit_id) && $edit_id>0){
                ...
                $sql="INSERT INTO teacher(full_name,phone_no,address)
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="full_name" name="full_name" value="<?php if(isset($full_name)){ echo $full_name;}?>" placeholder="Enter teacher Name" >
            </div>
            <div class="form-group">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
            <a href="teacher.php?edit_id=<?php echo $row['teacher_id']; ?> " 
            class="btn btn-warning btn-sm">Edit</a>
            <a href="teacher.php?delete_id=<?php echo $row['teacher_id']; ?>" 
